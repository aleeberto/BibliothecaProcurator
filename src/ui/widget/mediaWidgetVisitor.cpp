...
void MediaWidgetVisitor::addActionButtons(QHBoxLayout* layout, Media* media) {
...
void MediaWidgetVisitor::visit(Film* film) {
    resultWidget = createBaseWidget(film);
...
void MediaWidgetVisitor::visit(SerieTv* serieTv) {
    resultWidget = createBaseWidget(serieTv);
...
void MediaWidgetVisitor::visit(Anime* anime) {
    resultWidget = createBaseWidget(anime);
...
void MediaWidgetVisitor::visit(Libro* libro) {
    resultWidget = createBaseWidget(libro);
...
void MediaWidgetVisitor::visit(Manga* manga) {
    resultWidget = createBaseWidget(manga);
...
void MediaWidgetVisitor::visit(Cd* cd) {
    resultWidget = createBaseWidget(cd);
