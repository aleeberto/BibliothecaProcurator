...
# Project:  bibliotecaprocurator.pro
# Template: app
# Command: /usr/lib/qt5/bin/qmake -o Makefile bibliotecaprocurator.pro
#############################################################################
...
INCPATH       = -I. -Isrc -Isrc/app -Isrc/logic -Isrc/ui -I/usr/include/x86_64-linux-gnu/qt5 -I/usr/include/x86_64-linux-gnu/qt5/QtWidgets -I/usr/include/x86_64-linux-gnu/qt5/QtGui -I/usr/include/x86_64-linux-gnu/qt5/QtCore -I. -I/usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++
...
DISTDIR = /BibliothecaProcurator/BibliothecaProcurator/.tmp/my_project1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
...
DIST          = /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		...
		bibliotecaprocurator.pro src/app/jsonService.h \
		src/logic/anime.h \
		...
		src/ui/mainWindow.h \
		src/ui/topMenuWidget.h src/main.cpp \
		src/app/jsonService.cpp \
		src/app/mediaService.cpp \
		src/logic/anime.cpp \
		src/logic/cartaceo.cpp \
...
Makefile: bibliotecaprocurator.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/sanitize.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
		...
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/yacc.prf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/lex.prf \
		bibliotecaprocurator.pro
	$(QMAKE) -o Makefile bibliotecaprocurator.pro
...
distdir: FORCE
	...
	$(COPY_FILE) --parents src/app/jsonService.h src/logic/anime.h src/logic/cartaceo.h src/logic/cd.h src/logic/film.h src/logic/libro.h src/logic/manga.h src/logic/media.h src/logic/series.h src/logic/serieTv.h src/ui/createItemWidget.h src/ui/mainWindow.h src/ui/topMenuWidget.h $(DISTDIR)/
	$(COPY_FILE) --parents src/main.cpp src/app/jsonService.cpp src/app/mediaService.cpp src/logic/anime.cpp src/logic/cartaceo.cpp src/logic/cd.cpp src/logic/film.cpp src/logic/libro.cpp src/logic/manga.cpp src/logic/media.cpp src/logic/series.cpp src/logic/serieTv.cpp src/ui/createItemWidget.cpp src/ui/mainWindow.cpp src/ui/topMenuWidget.cpp $(DISTDIR)/
...
moc_jsonService.cpp: src/app/jsonService.h \
		src/logic/media.h \
		moc_predefs.h \
		/usr/lib/qt5/bin/moc
	/usr/lib/qt5/bin/moc $(DEFINES) --include /BibliothecaProcurator/BibliothecaProcurator/moc_predefs.h -I/usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++ -I/BibliothecaProcurator/BibliothecaProcurator -I/BibliothecaProcurator/BibliothecaProcurator/src -I/BibliothecaProcurator/BibliothecaProcurator/src/app -I/BibliothecaProcurator/BibliothecaProcurator/src/logic -I/BibliothecaProcurator/BibliothecaProcurator/src/ui -I/usr/include/x86_64-linux-gnu/qt5 -I/usr/include/x86_64-linux-gnu/qt5/QtWidgets -I/usr/include/x86_64-linux-gnu/qt5/QtGui -I/usr/include/x86_64-linux-gnu/qt5/QtCore -I/usr/include/c++/11 -I/usr/include/x86_64-linux-gnu/c++/11 -I/usr/include/c++/11/backward -I/usr/lib/gcc/x86_64-linux-gnu/11/include -I/usr/local/include -I/usr/include/x86_64-linux-gnu -I/usr/include src/app/jsonService.h -o moc_jsonService.cpp
...
jsonService.o: src/app/jsonService.cpp src/app/jsonService.h \
		src/logic/media.h \
		src/logic/film.h \
		src/logic/serieTv.h \
		src/logic/series.h \
		...
		src/logic/manga.h \
		src/logic/cd.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o jsonService.o src/app/jsonService.cpp

mediaService.o: src/app/mediaService.cpp src/app/mediaService.h \
		src/logic/media.h \
		src/app/jsonService.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o mediaService.o src/app/mediaService.cpp
